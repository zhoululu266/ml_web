    ...
    <div class="content">
      ...
      <div class="login">
        <div class="title-box">
          ...
          <span style="color: #9c9da0">/忘记密码</span>
        </div>
        ...
        <div class="login-content">
          ...
          >
            <div class="zczh-box">
              <div><img src="../assets/wjmmIcon.png" alt="" /></div>
              <div>重置密码</div>
            </div>
              ...
              >
                <template #append>
                  <el-button
                    ...
                    >获取验证码</el-button
                  >
                  <!-- <el-button class="hq-btn" v-if="!data.show"
                    >{{ data.count }}(s)重新获取</el-button
                  > -->
                  <el-button class="hq-btn" v-if="!data.show">{{
                    `${data.count}(s)重新获取`
                  }}</el-button>
            ...
            <el-form-item>
              <div class="btn-box">
                <div class="btn1" @click="onSignIn">提交</div>
              </div>
            </el-form-item>
          </el-form>
        </div>
...
const xgruleFormRef = ref();
const onSignIn = async () => {
  const valid = await xgruleFormRef.value?.validate();
  if (!valid) return;
  await axios
    .post(`${url.api}/motorcycleService/motorcycle/reset`, {
