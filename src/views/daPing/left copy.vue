...
const total = ref();
const columns = ref([
  { prop: "name", label: "姓名", width: 100, span: 7 },
  { prop: "department", label: "部门", span: 6 },
  { prop: "dq", label: "负责地区", span: 5 },
  { prop: "case_number", label: "调解数", class: "ttjs", span: 3 },
]);
const columns1 = ref([
  { prop: "name", label: "姓名", span: 6 },
  { prop: "area", label: "负责地区", span: 6 },
  { prop: "case_number", label: "调解数", class: "ttjs", span: 6 },
]);
const tableData = ref([]);
const tableDataTjy = ref([]);
const tableDataTjyTans = ref([]);
